...
public class UKMakerSpace {
    public static void main(String[] args) throws Exception{
        ...
        JavaRDD<String> makerSpaceRdd = javaSparkContext.textFile("uk-makerspaces-identifiable-data.csv");
    ...
    private static Map<String, String> loadPostCodeMap() throws FileNotFoundException{
            Scanner postCode = new Scanner(new File("uk-postcode.csv"));
